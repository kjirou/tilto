...
function initializeBox(
  ...
  box.matrix = matrixUtils.initializeMatrix(rectangle, actualOptions.symbol);
...
function render(
  ...
  let outputBuffer/*: Matrix*/ = box.matrix.map(row => {
  ...
  if (box.content !== '') {
    ...
    if (contentAreaMatrix) {
      ...
      outputBuffer = matrixUtils.overwriteMatrix(outputBuffer, newContentAreaMatrix, {
        x: contentArea.x,
        y: contentArea.y,
      });
    }
  ...
  return matrixUtils.toText(outputBuffer);
}
